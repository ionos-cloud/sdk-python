...
import ionos_cloud_sdk_python.models
from ionos_cloud_sdk_python import rest
from ionos_cloud_sdk_python.exceptions import ApiValueError, ApiException, ApiFailedRequest, ApiTimeout
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(ionos_cloud_sdk_python.models, klass)
