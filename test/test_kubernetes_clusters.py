...
import ionossdk
from ionossdk.models.kubernetes_clusters import KubernetesClusters  # noqa: E501
...
class TestKubernetesClusters(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = ionossdk.models.kubernetes_clusters.KubernetesClusters()  # noqa: E501
        if include_optional :
            return KubernetesClusters(
                ...
                href = '<RESOURCE-URI>', 
                items = [
                    ionossdk.models.kubernetes_cluster.KubernetesCluster(
