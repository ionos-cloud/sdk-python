...
from ionos_cloud_sdk_python.models.snapshots import Snapshots  # noqa: E501
...
class TestSnapshots(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = ionos_cloud_sdk_python.models.snapshots.Snapshots()  # noqa: E501
        if include_optional :
            return Snapshots(
                ...
                href = '<RESOURCE-URI>', 
                items = [
                    ionos_cloud_sdk_python.models.snapshot.Snapshot(
                        id = '15f67991-0f51-4efc-a8ad-ef1fb31a480c', 
                        type = "snapshot", 
                        href = '<RESOURCE-URI>', 
