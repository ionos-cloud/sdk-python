...
import ionossdk
from ionossdk.models.firewall_rules import FirewallRules  # noqa: E501
...
class TestFirewallRules(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = ionossdk.models.firewall_rules.FirewallRules()  # noqa: E501
        if include_optional :
            return FirewallRules(
                ...
                href = '<RESOURCE-URI>', 
                items = [
                    ionossdk.models.firewall_rule.FirewallRule(
                        id = '15f67991-0f51-4efc-a8ad-ef1fb31a480c', 
                        type = "firewall-rule", 
                        href = '<RESOURCE-URI>', 
