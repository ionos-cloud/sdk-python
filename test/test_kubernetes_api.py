...
from ionos_cloud_sdk_python.api.kubernetes_api import KubernetesApi  # noqa: E501
...
class TestKubernetesApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = ionos_cloud_sdk_python.api.kubernetes_api.KubernetesApi()  # noqa: E501
