...
from ionos_cloud_sdk_python.models.s3_keys import S3Keys  # noqa: E501
...
class TestS3Keys(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = ionos_cloud_sdk_python.models.s3_keys.S3Keys()  # noqa: E501
        if include_optional :
            return S3Keys(
                ...
                items = [
                    ionos_cloud_sdk_python.models.s3_key.S3Key(
                        id = '15f67991-0f51-4efc-a8ad-ef1fb31a480c', 
                        type = "group", 
