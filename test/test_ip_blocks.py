...
from ionos_cloud_sdk_python.models.ip_blocks import IpBlocks  # noqa: E501
...
class TestIpBlocks(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = ionos_cloud_sdk_python.models.ip_blocks.IpBlocks()  # noqa: E501
        if include_optional :
            return IpBlocks(
                ...
                href = '<RESOURCE-URI>', 
                items = [
                    ionos_cloud_sdk_python.models.ip_block.IpBlock(
                        id = '15f67991-0f51-4efc-a8ad-ef1fb31a480c', 
                        type = "ipblock", 
                        href = '<RESOURCE-URI>', 
                        metadata = ionos_cloud_sdk_python.models.datacenter_element_metadata.DatacenterElementMetadata(
                            ...
                            state = 'AVAILABLE', ), 
                        properties = ionos_cloud_sdk_python.models.ip_block_properties.IpBlockProperties(
