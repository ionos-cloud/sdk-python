...
class LabelsApi(object):
    ...
    def images_labels_delete(self, image_id, key, **kwargs):  # noqa: E501
        """Delete image label  # noqa: E501

        Delete the specified image label.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.images_labels_delete(image_id, key, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.images_labels_delete_with_http_info(image_id, key, **kwargs)  # noqa: E501

    def images_labels_delete_with_http_info(self, image_id, key, **kwargs):  # noqa: E501
        """Delete image label  # noqa: E501
        ...
        >>> thread = api.images_labels_delete_with_http_info(image_id, key, async_req=True)
        >>> result = thread.get()
        ...
        for local_var_params_key, local_var_params_val in six.iteritems(local_var_params['kwargs']):
            if local_var_params_key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method images_labels_delete" % local_var_params_key
                )
            local_var_params[local_var_params_key] = local_var_params_val
        del local_var_params['kwargs']
        ...
        if self.api_client.client_side_validation and ('image_id' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `image_id` when calling `images_labels_delete`")  # noqa: E501
        # verify the required parameter 'key' is set
        if self.api_client.client_side_validation and ('key' not in local_var_params or  # noqa: E501
                                                        local_var_params['key'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `key` when calling `images_labels_delete`")  # noqa: E501

        if self.api_client.client_side_validation and 'depth' in local_var_params and local_var_params['depth'] > 10:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `depth` when calling `images_labels_delete`, must be a value less than or equal to `10`")  # noqa: E501
        if self.api_client.client_side_validation and 'depth' in local_var_params and local_var_params['depth'] < 0:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `depth` when calling `images_labels_delete`, must be a value greater than or equal to `0`")  # noqa: E501
        collection_formats = {}
        ...
        return self.api_client.call_api(
            '/images/{imageId}/labels/{key}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def images_labels_find_by_key(self, image_id, key, **kwargs):  # noqa: E501
        """Retrieve image labels  # noqa: E501

        Retrieve the properties of the specified image label.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.images_labels_find_by_key(image_id, key, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.images_labels_find_by_key_with_http_info(image_id, key, **kwargs)  # noqa: E501

    def images_labels_find_by_key_with_http_info(self, image_id, key, **kwargs):  # noqa: E501
        """Retrieve image labels  # noqa: E501
        ...
        >>> thread = api.images_labels_find_by_key_with_http_info(image_id, key, async_req=True)
        >>> result = thread.get()
        ...
        for local_var_params_key, local_var_params_val in six.iteritems(local_var_params['kwargs']):
            if local_var_params_key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method images_labels_find_by_key" % local_var_params_key
                )
            local_var_params[local_var_params_key] = local_var_params_val
        del local_var_params['kwargs']
        # verify the required parameter 'image_id' is set
        if self.api_client.client_side_validation and ('image_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['image_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `image_id` when calling `images_labels_find_by_key`")  # noqa: E501
        # verify the required parameter 'key' is set
        if self.api_client.client_side_validation and ('key' not in local_var_params or  # noqa: E501
                                                        local_var_params['key'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `key` when calling `images_labels_find_by_key`")  # noqa: E501

        if self.api_client.client_side_validation and 'depth' in local_var_params and local_var_params['depth'] > 10:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `depth` when calling `images_labels_find_by_key`, must be a value less than or equal to `10`")  # noqa: E501
        if self.api_client.client_side_validation and 'depth' in local_var_params and local_var_params['depth'] < 0:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `depth` when calling `images_labels_find_by_key`, must be a value greater than or equal to `0`")  # noqa: E501
        collection_formats = {}
    ...
    def images_labels_get(self, image_id, **kwargs):  # noqa: E501
        """List image labels  # noqa: E501

        List all the the labels for the specified image.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.images_labels_get(image_id, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.images_labels_get_with_http_info(image_id, **kwargs)  # noqa: E501

    def images_labels_get_with_http_info(self, image_id, **kwargs):  # noqa: E501
        """List image labels  # noqa: E501
        ...
        >>> thread = api.images_labels_get_with_http_info(image_id, async_req=True)
        >>> result = thread.get()
        ...
        for local_var_params_key, local_var_params_val in six.iteritems(local_var_params['kwargs']):
            if local_var_params_key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method images_labels_get" % local_var_params_key
                )
            local_var_params[local_var_params_key] = local_var_params_val
        del local_var_params['kwargs']
        # verify the required parameter 'image_id' is set
        if self.api_client.client_side_validation and ('image_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['image_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `image_id` when calling `images_labels_get`")  # noqa: E501

        if self.api_client.client_side_validation and 'depth' in local_var_params and local_var_params['depth'] > 10:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `depth` when calling `images_labels_get`, must be a value less than or equal to `10`")  # noqa: E501
        if self.api_client.client_side_validation and 'depth' in local_var_params and local_var_params['depth'] < 0:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `depth` when calling `images_labels_get`, must be a value greater than or equal to `0`")  # noqa: E501
        collection_formats = {}
    ...
    def images_labels_post(self, image_id, label, **kwargs):  # noqa: E501
        """Create an Image Label  # noqa: E501

        Adds a new label to the specified image.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.images_labels_post(image_id, label, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.images_labels_post_with_http_info(image_id, label, **kwargs)  # noqa: E501

    def images_labels_post_with_http_info(self, image_id, label, **kwargs):  # noqa: E501
        """Create an Image Label  # noqa: E501
        ...
        >>> thread = api.images_labels_post_with_http_info(image_id, label, async_req=True)
        >>> result = thread.get()
        ...
        for local_var_params_key, local_var_params_val in six.iteritems(local_var_params['kwargs']):
            if local_var_params_key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method images_labels_post" % local_var_params_key
                )
            local_var_params[local_var_params_key] = local_var_params_val
        del local_var_params['kwargs']
        # verify the required parameter 'image_id' is set
        if self.api_client.client_side_validation and ('image_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['image_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `image_id` when calling `images_labels_post`")  # noqa: E501
        # verify the required parameter 'label' is set
        if self.api_client.client_side_validation and ('label' not in local_var_params or  # noqa: E501
                                                        local_var_params['label'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `label` when calling `images_labels_post`")  # noqa: E501

        if self.api_client.client_side_validation and 'depth' in local_var_params and local_var_params['depth'] > 10:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `depth` when calling `images_labels_post`, must be a value less than or equal to `10`")  # noqa: E501
        if self.api_client.client_side_validation and 'depth' in local_var_params and local_var_params['depth'] < 0:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `depth` when calling `images_labels_post`, must be a value greater than or equal to `0`")  # noqa: E501
        collection_formats = {}
    ...
    def images_labels_put(self, image_id, key, label, **kwargs):  # noqa: E501
        """Modify an Image Label by Key  # noqa: E501

        Modifies the specified data center label.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.images_labels_put(image_id, key, label, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.images_labels_put_with_http_info(image_id, key, label, **kwargs)  # noqa: E501

    def images_labels_put_with_http_info(self, image_id, key, label, **kwargs):  # noqa: E501
        """Modify an Image Label by Key  # noqa: E501
        ...
        >>> thread = api.images_labels_put_with_http_info(image_id, key, label, async_req=True)
        >>> result = thread.get()
        ...
        for local_var_params_key, local_var_params_val in six.iteritems(local_var_params['kwargs']):
            if local_var_params_key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method images_labels_put" % local_var_params_key
                )
            local_var_params[local_var_params_key] = local_var_params_val
        del local_var_params['kwargs']
        # verify the required parameter 'image_id' is set
        if self.api_client.client_side_validation and ('image_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['image_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `image_id` when calling `images_labels_put`")  # noqa: E501
        # verify the required parameter 'key' is set
        if self.api_client.client_side_validation and ('key' not in local_var_params or  # noqa: E501
                                                        local_var_params['key'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `key` when calling `images_labels_put`")  # noqa: E501
        # verify the required parameter 'label' is set
        if self.api_client.client_side_validation and ('label' not in local_var_params or  # noqa: E501
                                                        local_var_params['label'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `label` when calling `images_labels_put`")  # noqa: E501

        if self.api_client.client_side_validation and 'depth' in local_var_params and local_var_params['depth'] > 10:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `depth` when calling `images_labels_put`, must be a value less than or equal to `10`")  # noqa: E501
        if self.api_client.client_side_validation and 'depth' in local_var_params and local_var_params['depth'] < 0:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `depth` when calling `images_labels_put`, must be a value greater than or equal to `0`")  # noqa: E501
        collection_formats = {}
