...
class LocationApi(object):
    ...
    def locations_find_by_region_id_with_http_info(self, region_id, **kwargs):  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(Locations, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for local_var_params_key, local_var_params_val in six.iteritems(local_var_params['kwargs']):
            if local_var_params_key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method locations_find_by_region_id" % local_var_params_key
                )
        ...
        if 'region_id' in local_var_params:
            path_params['regionId'] = local_var_params['region_id']  # noqa: E501
    ...
    def locations_find_by_region_id_and_id_with_http_info(self, region_id, location_id, **kwargs):  # noqa: E501
        ...
        for local_var_params_key, local_var_params_val in six.iteritems(local_var_params['kwargs']):
            if local_var_params_key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method locations_find_by_region_id_and_id" % local_var_params_key
                )
            local_var_params[local_var_params_key] = local_var_params_val
        del local_var_params['kwargs']
        # verify the required parameter 'region_id' is set
        ...
        return self.api_client.call_api(
            '/locations/{regionId}/{locationId}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def locations_get(self, **kwargs):  # noqa: E501
        ...
        Retrieve a list of Locations. This list represents where you can provision your virtual data centers  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def locations_get_with_http_info(self, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and 'depth' in local_var_params and local_var_params['depth'] > 10:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `depth` when calling `locations_get`, must be a value less than or equal to `10`")  # noqa: E501
        if self.api_client.client_side_validation and 'depth' in local_var_params and local_var_params['depth'] < 0:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `depth` when calling `locations_get`, must be a value greater than or equal to `0`")  # noqa: E501
        collection_formats = {}
