...
class DatacenterProperties(object):
    ...
    def features(self, features):
        ...
        """
        allowed_values = ["SSD_STORAGE_ZONING", "pcc", "ssd", "nic-hot-unplug", "disk-vio-hot-unplug", "disk-vio-hot-plug", "vnf-nat-pcc-connection", "k8s", "cpu-hot-plug", "nic-hot-plug", "private-loadbalancer", "mem-hot-plug", "vnf-nlb-pcc-connection"]  # noqa: E501
