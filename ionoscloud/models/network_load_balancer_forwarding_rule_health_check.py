...
class NetworkLoadBalancerForwardingRuleHealthCheck(object):
    ...
    def __init__(self, client_timeout=None, check_timeout=None, connect_timeout=None, target_timeout=None, retries=None, local_vars_configuration=None):  # noqa: E501
    ...
    def check_timeout(self):
        """Gets the check_timeout of this NetworkLoadBalancerForwardingRuleHealthCheck.  # noqa: E501

        It specifies the time (in milliseconds) for a target VM in this pool to answer the check. If a target VM has CheckInterval set and CheckTimeout is set too, then the smaller value of the two is used after the TCP connection is established.  # noqa: E501

        :return: The check_timeout of this NetworkLoadBalancerForwardingRuleHealthCheck.  # noqa: E501
        :rtype: int
        """
    ...
    def check_timeout(self, check_timeout):
        """Sets the check_timeout of this NetworkLoadBalancerForwardingRuleHealthCheck.

        It specifies the time (in milliseconds) for a target VM in this pool to answer the check. If a target VM has CheckInterval set and CheckTimeout is set too, then the smaller value of the two is used after the TCP connection is established.  # noqa: E501

        :param check_timeout: The check_timeout of this NetworkLoadBalancerForwardingRuleHealthCheck.  # noqa: E501
