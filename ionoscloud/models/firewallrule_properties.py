...
class FirewallruleProperties(object):
    ...
    def __init__(self, name=None, protocol=None, source_mac=None, source_ip=None, target_ip=None, icmp_code=None, icmp_type=None, port_range_start=None, port_range_end=None, local_vars_configuration=None):  # noqa: E501
