...
class LocationProperties(object):
    ...
    def features(self, features):
        ...
        """
        allowed_values = ["SSD_STORAGE_ZONING", "pcc", "nic-hot-unplug", "disk-vio-hot-unplug", "ssd", "disk-vio-hot-plug", "vnf-nat-pcc-connection", "k8s", "cpu-hot-plug", "nic-hot-plug", "private-loadbalancer", "mem-hot-plug", "vnf-nlb-pcc-connection", "vnf-nat", "vnf-lb", "flow-logs", "core-vps"]  # noqa: E501
