...
class ApplicationLoadBalancerProperties(object):
    ...
    def __init__(self, name=None, listener_lan=None, ips=None, target_lan=None, lb_private_ips=None, central_logging=None, logging_format=None, local_vars_configuration=None):  # noqa: E501
    ...
    def central_logging(self):
        """Gets the central_logging of this ApplicationLoadBalancerProperties.  # noqa: E501

        Turn logging on and off for this product. Default value is 'false'.  # noqa: E501

        :return: The central_logging of this ApplicationLoadBalancerProperties.  # noqa: E501
        :rtype: bool
        """
        return self._central_logging

    @central_logging.setter
    def central_logging(self, central_logging):
        """Sets the central_logging of this ApplicationLoadBalancerProperties.

        Turn logging on and off for this product. Default value is 'false'.  # noqa: E501

        :param central_logging: The central_logging of this ApplicationLoadBalancerProperties.  # noqa: E501
        :type central_logging: bool
        """

        self._central_logging = central_logging

    @property
    def logging_format(self):
        """Gets the logging_format of this ApplicationLoadBalancerProperties.  # noqa: E501

        Specifies the format of the logs.  # noqa: E501

        :return: The logging_format of this ApplicationLoadBalancerProperties.  # noqa: E501
        :rtype: str
        """
    ...
    def logging_format(self, logging_format):
        """Sets the logging_format of this ApplicationLoadBalancerProperties.

        Specifies the format of the logs.  # noqa: E501

        :param logging_format: The logging_format of this ApplicationLoadBalancerProperties.  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ApplicationLoadBalancerProperties):
            return False
