...
class VolumeProperties(object):
    ...
    def __init__(self, name=None, type=None, size=None, availability_zone=None, image=None, image_password=None, ssh_keys=None, bus=None, licence_type=None, cpu_hot_plug=None, ram_hot_plug=None, nic_hot_plug=None, nic_hot_unplug=None, disc_virtio_hot_plug=None, disc_virtio_hot_unplug=None, device_number=None, pci_slot=None, backupunit_id=None, user_data=None, local_vars_configuration=None):  # noqa: E501
    ...
    def type(self, type):
        ...
        :type type: str
        """
        allowed_values = ["HDD", "SSD", "SSD Standard", "SSD Premium", "DAS"]  # noqa: E501
    ...
    def availability_zone(self):
        ...
        The availability zone in which the volume should exist. The storage volume will be provisioned on as less physical storages as possible but cannot guarantee upfront. It is not available for DAS (Direct Attached Storage) and subject of availability for SSD.  # noqa: E501
    ...
    def licence_type(self):
        ...
        OS type of this volume  # noqa: E501
    ...
    def device_number(self):
        ...
        The Logical Unit Number of the storage volume. Null for volumes not mounted to any VM  # noqa: E501
    ...
    def pci_slot(self):
        ...
        The PCI slot number of the storage volume. Null for volumes not mounted to any VM  # noqa: E501
