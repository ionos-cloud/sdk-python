...
class NatGatewayRuleProperties(object):
    ...
    def target_subnet(self):
        ...
        Target or destination subnet of the NAT gateway rule. For SNAT rules it specifies which packets this translation rule applies to based on the packets destination IP address. Useful for nat reflection/hairpin. If none is provided, rule will match any address.  # noqa: E501
