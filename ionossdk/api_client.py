...
import ionossdk.models
from ionossdk import rest
from ionossdk.exceptions import ApiValueError, ApiException, ApiFailedRequest, ApiTimeout
import ionossdk
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'ionos-cloud-sdk-python/ionossdk'
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(ionossdk.models, klass)
