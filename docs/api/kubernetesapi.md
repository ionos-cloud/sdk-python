...
| :--- | :--- | :--- |
| **202** | successful operation |  _X-RateLimit-Remaining - Number of requests which can still be made without triggering a failure response._     __ X-RateLimit-Limit - Average number of requests allowed per minute    \* X-RateLimit-Burst - Maximum number of concurrent API requests allowed   |
...
> KubernetesNodePoolForPut k8s\_nodepools\_put\(k8s\_cluster\_id, nodepool\_id, kubernetes\_node\_pool, pretty=pretty, depth=depth, x\_contract\_number=x\_contract\_number\)
